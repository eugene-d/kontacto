...
class PersonalAssistant:
    """Main application class for the Personal Assistant."""
    ...
    def _add_builtin_commands(self) -> None:
        ...
        class HelpCommand(BaseCommand):
            ...
            def execute(self, args, context):
                ...
                if args:
                    ...
                    command_name = args[0]
                    command = assistant.command_registry.get(command_name)
                    ...
                    if command:
                        ...
                        suggestions = find_best_match(
                            command_name,
                            assistant.command_registry.get_command_names()
                        )
                        if suggestions:
                            Console.info(f"Did you mean: {suggestions}?")
                else:
                    # Show all commands
                    Console.header("Personal Assistant - Available Commands")
                    
                    commands = assistant.command_registry.get_all_commands()
        ...
        class ExitCommand(BaseCommand):
            ...
            def execute(self, args, context):
                Console.info("Goodbye! Thank you for using Personal Assistant.")
                sys.exit(0)
    ...
    def run(self) -> None:
        ...
        Console.header("Welcome to Personal Assistant!")
        Console.info("Type 'help' to see available commands.")
